import React, { useState, useEffect, useCallback, lazy, Suspense, ComponentType, ReactElement } from 'react';
...
export const usePerformance = () => {
  ...
  const createLazyComponent = useCallback(<T extends ComponentType<any>>(
  ...
  const clearCache = useCallback(() => {
    cache.clear();
    setMetrics(prev => ({ ...prev, cacheHits: 0, cacheMisses: 0 }));
